...
const Home = () => {
  return (
    <main name='home' className="w-full h-screen bg-gray-100">
        <div className='pt-[180px] md:pt-0 max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
          <p className='text animate__animated animate__fadeIn'>Hi my name is</p>
          <h1 className='text-6xl sm:text-7xl font-bold text-red-900'>Peter Akojede</h1>
          <h2 className='text-red-800 text-3xl md:text-5xl  font-bold pt-2 md:pt-0'>I am a Full-Stack Developer</h2>
