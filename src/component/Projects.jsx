...
const Projects = () => {
  return (
    <main name="projects" className=" pt-[150px] md:pt-0 w-full mt-[100px] md:h-full">
      <div className="max-w-[1000px] mx-auto flex flex-col justify-center items-center p-4 h-full w-full">
        <div>
          <h1 className="font-bold text-4xl border-b-4 inline border-b-rose-900">
            Projects
          </h1>
            ...
            return (
              <div key={id}>
                <div
                  ...
                  className="shadow-lg shadow-gray-400 group container rounded-md flex justify-center items-center mx-auto projects-div"
                >
                  <div className="opacity-0 group-hover:opacity-100">
                    ...
                    <div className="pt-8 text-center text-white">
                      {/* <a href={link} target="_blank" rel="noreferrer">
                        <button className="py-3 px-2 rounded-lg m-2 bg-slate-700 text-white font-bold">
                          Source Code
                        </button>
                      </a> */}
                ...
                <p className="mt-[10px] font-bold  text-gray-800">
                  {title} Project
                </p>
